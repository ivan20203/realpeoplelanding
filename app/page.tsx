        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 lg:gap-12 mt-12">
            ...
            <div className="flex flex-col items-center space-y-2 rounded-lg border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Verified Profiles</h3>
            ...
            <div className="flex flex-col items-center space-y-2 rounded-lg border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Meaningful Connections</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-950">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:gap-12 mt-12">
            {/* Testimonial 1 */}
            <div className="flex flex-col justify-between space-y-4 rounded-lg border border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800">
              <div>
